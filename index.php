...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="Guest/User.php" class="nav-item nav-link">Register</a>
                    </div>
                    <a href="Guest/Login.php" class="btn btn-dark py-2 px-4 d-none d-lg-inline-block">Login</a>
                </div>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 text-center text-lg-start">
                    ...
                    <h1 class="display-4 text-white animated slideInRight">AQUARIUM FISHES <span class="fw-light text-dark">&</span> ACCESSORIES</h1>
                    <p class="text-white mb-4 animated slideInRight">AQUAFISHES is your premier destination for all things aquatic. Dive into a world of wonder as we provide you with the finest selection of aquarium fishes, mesmerizing aquariums, and expert insights into the art of underwater life.</p>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid animated pulse infinite" src="Assets/Template/User/img/Betta-PNG-Pic.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="Assets/Template/User/img/pngwing.com (3).png">
                </div>
  ...
  <!--  <div class="container-fluid deal bg-primary my-5 py-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="Assets/Template/User/img/Betta-PNG-Pic.png">
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
    ...
    <!--<div class="container-fluid py-5">
        <div class="container">
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="Assets/Template/User/img/fish.png">
                </div>
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="row g-5">
                        <div class="col-12 d-flex">
        ...
        <div class="container text-white py-5">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="text-white mb-3"><span class="fw-light text-dark">How To Use Our</span> Natural & Organic
                    <span class="fw-light text-dark">Fish Food</span></h1>
                <p class="mb-5"></p>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 text-center wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <h5 class="text-white">Feed Fish </h5>
                ...
                <div class="col-lg-4 text-center wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <h5 class="text-white">Pallet & Flakes</h5>
                    <hr class="w-25 bg-light my-2 mx-auto">
                    <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis aliquet, erat non malesuada consequat.</span>
                </div>
                <div class="col-lg-4 text-center wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h5 class="text-white">Correct Time</h5>
                    <hr class="w-25 bg-light my-2 mx-auto">
                    <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis aliquet, erat non malesuada consequat.</span>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.1s">
                        <div class="testimonial-item text-center" data-dot="1">
                            <img class="img-fluid border p-2" src="Assets/Template/User/img/testimonial-1.jpg" alt="">
                        ...
                        <div class="testimonial-item text-center" data-dot="2">
                            <img class="img-fluid border p-2" src="Assets/Template/User/img/testimonial-2.jpg" alt="">
                            <h5 class="fw-light lh-base text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis aliquet, erat non malesuada consequat, nibh erat tempus risus, vitae porttitor purus nisl vitae purus. Praesent tristique odio ut rutrum pellentesque. Fusce eget molestie est, at rutrum est. Nullam scelerisque libero nunc, vitae ullamcorper elit volutpat ut.</h5>
                            <h5 class="mb-1">Client Name</h5>
                            <h6 class="fw-light text-white fst-italic mb-0">Profession</h6>
                        </div>
                        <div class="testimonial-item text-center" data-dot="3">
                            <img class="img-fluid border p-2" src="Assets/Template/User/img/testimonial-3.jpg" alt="">
                            <h5 class="fw-light lh-base text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis aliquet, erat non malesuada consequat, nibh erat tempus risus, vitae porttitor purus nisl vitae purus. Praesent tristique odio ut rutrum pellentesque. Fusce eget molestie est, at rutrum est. Nullam scelerisque libero nunc, vitae ullamcorper elit volutpat ut.</h5>
                            <h5 class="mb-1">Client Name</h5>
                            <h6 class="fw-light text-white fst-italic mb-0">Profession</h6>
                        </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="blog-item border h-100 p-4">
                        ...
                        <p class="mb-4">Different Varieties Of Fishes </p>
                        <a href="" class="btn btn-outline-primary px-3">Read More</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="blog-item border h-100 p-4">
                        <img class="img-fluid mb-4" src="Assets/Template/User/img/maxresdefault.jpg" alt="">
                        <a href="" class="h5 lh-base d-inline-block">FISH FOOD</a>
                        <div class="d-flex text-black-50 mb-2">
                            <div class="pe-3">
                                <small class="fa fa-eye me-1"></small>
                        ...
                        <p class="mb-4">Fish Food for each fishes </p>
                        <a href="" class="btn btn-outline-primary px-3">Read More</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="blog-item border h-100 p-4">
                        <img class="img-fluid mb-4" src="Assets/Template/User/img/WallpaperDog-20338722.jpg" alt="">
                        ...
                        <p class="mb-4">Different Types Of Aquariums And Other Accesssories</p>
                        <a href="" class="btn btn-outline-primary px-3">Read More</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p class="mb-0">AQUAFISHES is your premier destination for all things aquatic. Dive into a world of wonder as we provide you with the finest selection of aquarium fishes, mesmerizing aquariums, and expert insights into the art of underwater life.</p>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <a class="btn btn-link" href="">FISH FOOD</a>
