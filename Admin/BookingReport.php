...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">AQUAFISHES</h1>
        <br><br>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<?php
				...
				$i=0;
			 $selQry = "select * from tbl_cart c inner join tbl_booking b on b.booking_id=c.booking_id inner join tbl_product p on p.product_id=c.product_id inner join tbl_user u on u.user_id=b.user_id";
			 
			 
			 
			 if(isset($_POST["btn_search"]))
			 {
				 $selQry = $selQry." and booking_date between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
			 }
			 //echo $selQry;    
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["product_description"]; ?></td>
