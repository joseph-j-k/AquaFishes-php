    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    <a href="Logut.php" target="_blank">
                        <i class="zmdi zmdi-account-circle"></i> <span>Logout</span>
                    </a>
                </li>

                <li class="sidebar-header">REPORTS</li>
                <li><a href="BookingReport.php"><i class="zmdi zmdi-coffee text-danger"></i> <span>Total Sales</span></a>
                </li>
                
                <li><a href="UserBar.php"><i class="zmdi zmdi-chart-donut text-success"></i>
                        <span>Product</span></a></li>

                <li><a href="Pie.php"><i class="zmdi zmdi-share text-info"></i> <span>Fishes</span></a>
                </li>
        ...
        <div class="content-wrapper">
            <div class="container-fluid ">
                    <div id="tab" style="display: flex;justify-content: center;">
                    <div>
