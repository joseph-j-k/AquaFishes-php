...
<body>
  <div id="tab" align="center">
    ...
    while ($data = $row->fetch_assoc()) {
      echo "'" . trim($data["subcategory_name"]) . "',";
    }
    ?>
  ];
  ...
  console.log('xValues:', xValues.length); // Add this line to log xValues
  console.log('yValues:', yValues.length); // Add this line to log yValues
