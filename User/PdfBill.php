...
$selqry=" select * from tbl_booking  b inner join tbl_user u on u.user_id = b.user_id where b.booking_id='".$_GET["id"]."'";
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span
                style="color:#F93;font-size:56px">AQUA FISHES</span>
            ...
            >
              <div>
                ...
                <p style="font-size: 14px">
                  <?php echo $data["user_delivery_address"] ?>
                  <br />
      ...
      >
        ...
        $total=0;
          ...
          <tr>
            ...
            <td><img src="../Assets/Files/Product   /<?php echo $res1["product_photo"];?>" width="119" height="92" /></td>
