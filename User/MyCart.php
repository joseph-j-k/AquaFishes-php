...
if (isset($_POST["btn_checkout"]) != "") {
    ...
    if ($rsc = $rsC->fetch_assoc()) {
        ...
        $upQry = "update tbl_booking set booking_date=curdate(),booking_amount='" . $amt . "' where booking_id='" . $rsc["booking_id"] . "'";
...
<div style="padding: 30px;" align="center">
    ...
    <div class="column-labels">
        ...
        <label class="product-price" style="width: 10%; text-align:center">Quantity</label>
    ...
    <form method="post">
        <div class="shopping-cart" style="margin-top: 50px">
            <?php
            $sel = "select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id where  booking_status='0'";
            $res = $conn->query($sel);
            while ($row = $res->fetch_assoc()) {
                ...
                if ($rowpr = $respr->fetch_assoc()) {
                    ...
                    if ($rowst = $resst->fetch_assoc()) {
                        ...
                        $selstocka = "select sum(cart_quantity) as stock from tbl_cart where product_id='" . $rowpr["product_id"] . "' and cart_status >0";
                        ...
                        <div class="product">
                            ...
                            <div class="product-quantity">
                                <input alt="<?php echo $row["cart_id"] ?>" type="number" value="<?php echo $row["cart_quantity"] ?>"
