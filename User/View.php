...
$selQuery = "SELECT * FROM tbl_product p INNER JOIN tbl_subcategory s ON p.subcategory_id = s.subcategory_id WHERE product_id = " . $_GET['pid'];
...
<body>
    <div class="container col-8 " style="margin-top: 600px;">
        <div >
<br/><br/><br/><br/>
