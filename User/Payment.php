...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    {
         $up ="update tbl_booking set payment_status='1' where booking_id='".$_SESSION["bid"]."'";
        if($conn->query($up))
        {?>
      <script type="text/javascript">
            alert("Payment Completed");
            setTimeout(function(){window.location.href='PdfBill.php?id=<?php echo $_SESSION["bid"] ?> '},100);
        </script><?php
        }
    }?>
    <body>
                ...
                <div class="form">
                    <form method="post">
                        <div class="card space icon-relative">
                            ...
                            <input type="text" class="input" placeholder="Card Holder" required="required">
